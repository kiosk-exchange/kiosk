...
import './PublicOrderTracker.sol';

/**
*  This is a market where registered products can be bought and sold.
*/
contract PublicKiosk {
    ...
    PublicOrderTracker public orderTracker;
